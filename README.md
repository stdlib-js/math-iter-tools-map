...
```javascript
import iterMap from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-tools-map@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-iter-tools-map/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/math-iter-tools-map/actions/workflows/test.yml?query=branch:v0.2.3
