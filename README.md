...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-iter-tools-map/tags). For example,

```javascript
iterMap = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-tools-map@v0.2.0-umd/browser.js' )
```
